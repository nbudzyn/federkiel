...
@Immutable
@ThreadSafe
public abstract class UnaryCompoundPlurivalTerm
<T extends Object, S extends Object, A extends IAssignment>
implements IPlurivalTerm<T, A> {
	...
	public final Plurival<T> evaluate(final A assignment) throws UnassignedVariableException {
		...
		subResults =
			this.subTerm.evaluate(assignment); // UnassignedVariableException

		// evaluate all possible combinations
		final ImmutableList.Builder<T> res = ImmutableList.<T>builder();

		for (final S subResult : subResults) {
			res.addAll(calculate (subResult));
		}
	...
	/**
	 * Calculates the alternative values of the term for these to input value.<p>
	...
	public boolean equals(final Object obj) {
		...
		final UnaryCompoundPlurivalTerm<? extends Object, ? extends Object,
				? extends IAssignment> other =
					(UnaryCompoundPlurivalTerm<? extends Object, ? extends Object,
