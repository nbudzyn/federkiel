 ...
 * @author nbudzyn 2009
 */
public final class SafeCastPlurivalTerm<UT extends Object, ST extends UT,
...
implements IPlurivalTerm<UT, SA> {
	...
	UA extends IAssignment, SA extends UA>
	SafeCastPlurivalTerm<UT, ST, UA, SA> of (final IPlurivalTerm<ST, UA> term) {
		return new SafeCastPlurivalTerm<UT, ST, UA, SA>(term);
	}
	...
	public Plurival<UT> evaluate(final SA variableAssignment) throws UnassignedVariableException {
		...
		final Plurival<ST> uncastedAlternatives =
			this.term.evaluate(variableAssignment); // UnassignedVariableException
