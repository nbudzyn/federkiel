...
/**
 * A plurivalent term, that is build up from two (sub-)terms (could be something like two
 * terms, joined by a union operator, e.g.).<p>
...
@Immutable
@ThreadSafe
public abstract class BinaryCompoundPlurivalTerm<T extends Object, S1 extends Object, S2 extends Object,
A extends IAssignment>
implements IPlurivalTerm<T, A> {

	private final IPlurivalTerm<S1, A> firstSubTerm;
	private final IPlurivalTerm<S2, A> secondSubTerm;

	public BinaryCompoundPlurivalTerm(
			final IPlurivalTerm<S1, A> firstSubTerm,
	...
	public final Plurival<T> evaluate(final A assignment) throws UnassignedVariableException {
		...
		try {
			firstAlternativeSubResults =
				this.firstSubTerm.evaluate(assignment); // UnassignedVariableException
			...
			final Plurival<S2> secondAlternativeSubResults =
				this.secondSubTerm.evaluate(assignment); // UnassignedVariableException
		...
		for (final S1 firstSubResult : firstAlternativeSubResults) {
			for (final S2 secondSubResult : secondAlternativeSubResults) {
				res.addAll(calculate (firstSubResult, secondSubResult));
			}
		}
	...
	/**
	 * Calculates the alternative values of the term for these to input values.<p>
	...
	public boolean equals(final Object obj) {
		...
		@SuppressWarnings("unchecked")
		final BinaryCompoundPlurivalTerm<? extends Object, ? extends Object, ? extends Object,
				? extends IAssignment> other =
					(BinaryCompoundPlurivalTerm<? extends Object, ? extends Object, ? extends Object,
							? extends IAssignment>) obj;
	...
	public int compareTo(final IPlurivalTerm<? extends Object, ? extends IAssignment> o) {
		...
		final int firstSubTermsCompared =
			this.firstSubTerm.compareTo(other.firstSubTerm);
