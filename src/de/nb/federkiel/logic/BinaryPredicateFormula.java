...
/**
 * A formula, that is build up from two terms (could be something like an
 * equality, e.g.).<p>
...
implements IFormula<A> {
	...
	public boolean equals(final Object obj) {
		...
		final BinaryPredicateFormula<? extends Object, ? extends Object, ? extends IAssignment> other =
			(BinaryPredicateFormula<? extends Object, ? extends Object, ? extends IAssignment>) obj;
	...
	public int compareTo(final IFormula<? extends IAssignment> obj) {
		...
		final BinaryPredicateFormula<?, ?, ? extends IAssignment> other =
			(BinaryPredicateFormula<?, ?, ? extends IAssignment>) obj;

		final int firstTermsCompared =
			this.firstTerm.compareTo(other.firstTerm);
