...
@Immutable
@ThreadSafe
abstract class BinaryLogicalOperatorFormula<A extends IAssignment>
implements IFormula<A> {
	...
	/**
	 * The string to use for the (infix) operator (when displaying the
	 * formula), (&quot;AND&quot;, e.g.)
	 */
	private final String operatorString;

	protected BinaryLogicalOperatorFormula(
			final IFormula<A> firstFormula, final IFormula<A> secondFormula,
	...
	public int compareTo(final IFormula<? extends IAssignment> obj) {
		...
		final int firstFormulasCompared =
			this.firstFormula.compareTo(other.firstFormula);
