...
/**
 * A term, that is build up from two (sub-)terms (could be something like two
...
@Immutable
@ThreadSafe
public abstract class BinaryCompoundTerm<T extends Object, S1 extends Object, S2 extends Object,
...
implements ITerm<T, A> {
	...
	@Override
	public final T evaluate(final A assignment) throws UnassignedVariableException {
		final S1 firstSubResult =
			this.firstSubTerm.evaluate(assignment); // UnassignedVariableException
		final S2 secondSubResult =
			this.secondSubTerm.evaluate(assignment); // UnassignedVariableException

		return calculate (firstSubResult, secondSubResult);
	}

	/**
	 * Calculates the value of the term for these to input values.<p>
	 * This method is called by evaluate().
	 */
	abstract public T calculate(S1 first, S2 second);
	...
	public boolean equals(final Object obj) {
		...
		final BinaryCompoundTerm<? extends Object, ? extends Object, ? extends Object,
				? extends IAssignment> other =
					(BinaryCompoundTerm<? extends Object, ? extends Object, ? extends Object,
							? extends IAssignment>) obj; // (unechecked warning)
