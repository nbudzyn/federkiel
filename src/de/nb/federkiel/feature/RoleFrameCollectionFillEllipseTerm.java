...
/**
 * A term that joins two role frame collections, in which the left one acts as the
 * BASE for filling some &quot;blanks&quot; in the right one, the ELLIPSE.
 * <p>
 * When X and Y are role frame collections, the resulting role frame
 * collection contains all ellipse-fillings of each role frame of X with each role frame of Y.
 * <p>
 ...
 *
 * In some cases, this operation is not possible, in other cases
 * there are several possibilities
 * (filling A fills slot X, filling B fills Slot Y; or the other way round). So, there are
 * several result alternatives.
 *
 * @author nbudzyn 2009
 */
