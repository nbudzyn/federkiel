...
public class StringFeatureValue implements IFeatureValue {
	/**
	 * All generated String feature values shall be cached - to minimize memory
	 ...
	 */
	final private static WeakCache<StringFeatureValue> cache =
			new WeakCache<>();

  public static final StringFeatureValue J = of("j");
  public static final StringFeatureValue N = of("n");
	...
	private StringFeatureValue(final String string) {
		...
		if (string == null) {
			throw new IllegalArgumentException("String for string feature "+
			"was null - not allowed.");
		}
  ...
  public static StringFeatureValue of(final boolean b) {
	 ...
	 * String features are always completed (even if there value were empty!)
	 */
	@Override
	...
	throws TooManyDifferencesException {
		...
		if (!this.string.equals(otherStringFeatureValue.string)) {
			throw new TooManyDifferencesException(
			"Values not equal: Other string feature value is different!");
		}
