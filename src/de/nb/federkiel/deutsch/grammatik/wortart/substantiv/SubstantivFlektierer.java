...
public class SubstantivFlektierer implements IFlektierer {
  ...
  /**
   * Die Reihenfolge ist relevant! Das erste "sticht"! Außerdem gehen diese vor (wenn hier etwas
   * passt, wird <code>AUSNAHMEENDEN_PLURAL</code> NICHT berücksichtigt!)
   */
  ...
  /**
   * Ausnahmen für Flexionsklassen - NUR FÜR MASKULINE NOMEN! Die Reihenfolge ist relevant! Das
   * erste "sticht"!
   */
  ...
  private static final String[] FREMDE_MASK_WORTAUSGAENGE_PLURAL_BELEBT_MIT_EN =
      new String[] {"and", // Doktoand -> Doktoranden
  ...
  static {
    AUSNAHMEENDEN_MIT_ALTERNATIVEN_PLURAL = new ImmutableSet.Builder<Pair<String, String[]>>().add(
        Pair.of("blau", new String[] {"blau", "blaus"})).add(
            Pair.of("bogen", new String[] {"bogen", "bögen"})).add(Pair.of("bypass",
                new String[] {"bypässe", "bypasses"})).add(Pair.of("embryo", new String[] {
                    "embryonen", "embryos"})).add(Pair.of(
                        "gelb",
                        new String[] {"gelb", "gelbs"})).add(Pair.of("general", new String[] {
                            "generale", "generäle"})).add(Pair.of("grün", new String[] {"grün",
                                "grüns"})).add(Pair.of("monitor", new String[] {"monitore",
                                    "monitoren"})).add(Pair.of("motor", new String[] {"motore",
                                        "motoren"})).add(Pair.of("index", new String[] {"indexe",
                                            "indizes"})).add(Pair.of("interface", new String[] {
                                                "interface", // laut
                                                // Duden
                                                "interfaces"})).add(Pair.of("konto", new String[] {
                                                    "konti", "kontos", "konten"})).add(Pair.of(
                                                        "lexikon",
                                                        new String[] {"lexika", "lexiken"})).add(
                                                            Pair.of("lila", new String[] {"lila",
                                                                "lilas"})).add(Pair.of(
                                                                    "pink",
                                                                    new String[] {"pink",
                                                                        "pinks"})).add(Pair.of(
    ...
    AUSNAHMEENDEN_PLURAL =
        new ImmutableSet.Builder<Pair<String, String>>().add(Pair.of("käse", "käse")). // *Käsen
                                                                                       // (auch
                                                                                       // Hüttenkäse
        // etc.)
            add(Pair.of("nackedei", "nackedeis")).add(Pair.of("kotau", "kotaus")).add(
                Pair.of("ajatollah", "ajatollahs")).add(Pair.of("see", "seen")).add(
                    Pair.of("nis", "nisse")). // Geheimnis ->
                                              // Geheimnisse
            ...
            add(Pair.of("kraft", "kräfte")).add(Pair.of("hand", "hände")).add(
                Pair.of("not", "nöte")).add(Pair.of("schnur", "schnüre")).add(
                    Pair.of("nuss", "nüsse")).add(Pair.of("maus", "mäuse")).add(
                        Pair.of("wand", "wände")).add(Pair.of("gans", "gänse")).add(
                            Pair.of("stadt", "städte")).add(Pair.of("kunst", "künste")).add(
                                Pair.of("wurst", "würste")).
            ...
            add(Pair.of("fürst", "fürsten")).add(Pair.of("prinz", "prinzen")).add(
                Pair.of("held", "helden")).add(Pair.of("narr", "narren")).add(
                    Pair.of("graf", "grafen")).add(Pair.of("staat", "staaten")).add(
                        Pair.of("muskel", "muskeln")).add(Pair.of("vetter", "vettern")).add(
                            Pair.of("konsul", "konsuln")).add(Pair.of("schaft", "schaften")).add(
                                Pair.of("ohr", "ohren")).add(Pair.of("auge", "augen")).add(
                                    Pair.of("ende", "enden")).add(
                                        Pair.of("interesse", "interessen")).add(
                                            Pair.of("vagabund", "vagabunden")).add(
                                                Pair.of("bär", "bären")).add(
                                                    Pair.of("soph", "sophen")). // Fremdwort-Endung?
                                                                                // Siehe oben bzgl
                                                                                // Genitiv!
            ...
            add(Pair.of("gedeck", "gedecke")). // vgl. Duden 283
                                               // Ausnahme
            add(Pair.of("ldeck", "ldecken")).add(Pair.of("ndeck", "ndecken")).add(
                Pair.of("rdeck", "rdecken")).add(Pair.of("deck", "decks")).add(
                    Pair.of("wrack", "wracks")).add(Pair.of("haff", "haffs")).

            // Maskulina und Neutra mit er-Plural
            add(Pair.of("geist", "geister")).add(Pair.of("land", "länder")).add(
                Pair.of("lied", "lieder")).add(Pair.of("wald", "wälder")).add(
                    Pair.of("wurm", "würmer")).add(Pair.of("strauch", "sträucher")).add(
                        Pair.of("kind", "kinder")).add(Pair.of("bild", "bilder")).add(
                            Pair.of("brett", "bretter")).add(Pair.of("feld", "felder")).add(
                                Pair.of("loch", "löcher")).add(Pair.of("haus", "häuser")).add(
                                    Pair.of("reichtum", "reichtümer")).add(
                                        Pair.of("fass", "fässer")).add(
                                            Pair.of("buch", "bücher")).add(
                                                Pair.of("horn", "hörner")).
            ...
            add(Pair.of("tag", "tage")).add(Pair.of("huf", "hufe")).add(
                Pair.of("hund", "hunde")).add(Pair.of("lachs", "lachse")).add(
                    Pair.of("barsch", "barsche")).add(Pair.of("mittwoch", "mittwoche")).add(
                        Pair.of("bar", "bars")). // Bar -> Bars
            add(Pair.of("ar", "are")).add(Pair.of("august", "auguste")).add(
                Pair.of("kontrast", "kontraste")).

            // Maskulina mit endunslosem Plural ohne Umlaut (282)
            add(Pair.of("balken", "balken")).add(Pair.of("stapel", "stapel")).add(
                Pair.of("stummel", "stummel")).add(Pair.of("haufen", "haufen")).add(
                    Pair.of("computer", "computer")).add(Pair.of("schwarz", "schwarz")). // Duden
                                                                                         // 291
            ...
            add(Pair.of("sauna", "saunas")).add(Pair.of("thema", "themen")).add(
                Pair.of("spirans", "spiranten")). // Duden 286
            add(Pair.of("stimulans", "stimulantien")). // Duden 286
            add(Pair.of("bus", "busse")).add(Pair.of("dus", "di")).add(Pair.of("fus", "fi")).add(
                Pair.of("gus", "gi")).add(Pair.of("sozius", "soziusse")). // Duden 289
            add(Pair.of("zirkus", "zirkusse")).add(Pair.of("zyklus", "zyklen")).add(
                Pair.of("lus", "li")). // Stimulus -> Stimuli
            add(Pair.of("rhythmus", "rhythmen")).add(Pair.of("smus", "smen")). // Organismus ->
                                                                               // Organismen
            add(Pair.of("mus", "mi")).add(Pair.of("tenor", "tenöre")).add(
                Pair.of("genus", "genera")).add(Pair.of("nus", "ni")). // Bonus -> Boni
            add(Pair.of("tempus", "tempora")).add(Pair.of("quus", "qui")).add(
                Pair.of("rus", "ri")).add(Pair.of("sus", "sus")). // Kasus -> Kasus
            add(Pair.of("ritus", "riten")).add(Pair.of("vus", "vi")).add(Pair.of("vus", "vi")).add(
                Pair.of("xus", "xi")).
            ...
            // Projektil ->
            // Projektile
            add(Pair.of("gur", "guren")).add(Pair.of("ion", "ionen")).add(
                Pair.of("prinzip", "prinzipien")).add(Pair.of("totem", "totems")). // Problem,
                                                                                   // Theorem
            ...
            add(Pair.of("ostern", "ostern")).add(Pair.of("pfingsten", "pfingsten")).add(
                Pair.of("weihnachten", "weihnachten")).
            build();

    AUSNAHMEENDEN_STAMMABWEICHUNGEN_KASUSFLEXION =
        new ImmutableSet.Builder<Pair<String, String>>().add(Pair.of("aas", "aas")).add(
            Pair.of("as", "ass")). // Atlas -> Atlasses
            add(Pair.of("anis", "anis")). // Anis -> Anises
            add(Pair.of("ees", "ees")).add(Pair.of("ies", "ies")).add(Pair.of("oes", "oes")).add(
                Pair.of("es", "es")).add(Pair.of("ais", "ais")).add(Pair.of("eis", "eis")).add(
                    Pair.of("iis", "iis")).add(Pair.of("ois", "ois")).add(
                        Pair.of("uis", "uis")).add(Pair.of("is", "iss")). // Geheimnis
                                                                          // ->
                                                                          // Geheimnisses,
                                                                          // ...
            add(Pair.of("oos", "oos")).add(Pair.of("os", "oss")). // Rhinozeros -> des
                                                                  // Rhinozerosses
            add(Pair.of("aus", "aus")).add(Pair.of("äus", "äus")).add(Pair.of("eus", "eus")).add(
                Pair.of("us", "uss")). // Bus ->
            // des
            // Busses,
            // dem
    ...
    AUSNAHMEENDEN_MIT_ALTERNATIVEN_MASK_FLEXIONSKLASSEN =
        new ImmutableSet.Builder<Pair<String, EnumSet<SubstantivFlexionsklasse>>>().add(
            Pair.of("buchstabe", // vgl. Duden 340
                EnumSet.of(SubstantivFlexionsklasse.GEMISCHT_TYP_BUCHSTABE))).add(
                    Pair.of("fels", // vgl. Duden 339
                        EnumSet.of(SubstantivFlexionsklasse.GEMISCHT_TYP_FELS)))
            // Herz/Kunstherz ist NEUTRUM - wird daher separat
            // behandelt!
            .add(Pair.of("haufen", EnumSet.of(SubstantivFlexionsklasse.GEMISCHT_TYP_FRIEDE))).add(
                Pair.of("gedanke", EnumSet.of(SubstantivFlexionsklasse.GEMISCHT_TYP_FRIEDE))).add(
                    Pair.of("gefallen",
                        EnumSet.of(SubstantivFlexionsklasse.GEMISCHT_TYP_FRIEDE))).add(Pair.of(
                            "schaden", EnumSet.of(
                                SubstantivFlexionsklasse.GEMISCHT_TYP_FRIEDE))).add(Pair.of(
                                    "glaube", // Glaube, Aberglaube
                                    EnumSet.of(SubstantivFlexionsklasse.GEMISCHT_TYP_FRIEDE))).add(
                                        Pair.of("frieden", EnumSet.of(
                                            SubstantivFlexionsklasse.GEMISCHT_TYP_FRIEDE))).add(
                                                Pair.of("name", EnumSet.of(
                                                    SubstantivFlexionsklasse.GEMISCHT_TYP_FRIEDE))).add(
                                                        Pair.of("samen", EnumSet.of(
                                                            SubstantivFlexionsklasse.GEMISCHT_TYP_FRIEDE))).add(
                                                                Pair.of("funken", EnumSet.of(
                                                                    SubstantivFlexionsklasse.GEMISCHT_TYP_FRIEDE))).add(
                                                                        Pair.of("wille", // Wille,
                                                                                         // Unwille
                                                                            EnumSet.of(
                                                                                SubstantivFlexionsklasse.GEMISCHT_TYP_FRIEDE))).add(
                                                                                    Pair.of(
                                                                                        "drache", // vgl.
                                                                                                  ...
                                                                                                  // 339
                                                                                        EnumSet.of(
                                                                                            SubstantivFlexionsklasse.GEMISCHT_TYP_DRACHE))).add(
                                                                                                Pair.of(
                                                                                                    "et",
                                                                                                    // Magnet
                                                                                                    EnumSet.of(
            ...
            // Bauern
                ...
                SubstantivFlexionsklasse.STARK_II // des
            // Vetters
            ))).add(Pair.of("ostern", EnumSet.of(SubstantivFlexionsklasse.ENDUNGSLOS_I))).add(Pair.of("pfingsten", EnumSet.of(SubstantivFlexionsklasse.ENDUNGSLOS_I))).add(Pair.of("weihnachten", EnumSet.of(SubstantivFlexionsklasse.ENDUNGSLOS_I))).build();
  }
   ...
   *
   * @param lexeme <i>kein</i> Plurale Tantum!
   * @param lexemStehtMitArtikelAusserImTelegrammstil ob das Lexem in der Regel mit Artikel steht
   *        ("das Haus", "die Schweiz") oder nicht ("Deutschland")
   */
  public Collection<IWordForm> std(final Lexeme lexeme, final String pos, final boolean zaehlbar,
    ...
    final Collection<String> pluralAlternativen = zaehlbar ? plural(lexeme, fremdwortTyp,
    ...
    res.addAll(stdSingular(lexeme, pos, lexemStehtMitArtikelAusserImTelegrammstil,
        ...
        stoffbezeichnungSammelbezeichnungOderAbstraktumArtikelOptional, fremdwortTyp,
        kommtEinemEigennameNaheDassGenitivSAuchEntfallenKann, personOderTier, pluralAlternativen));

    pluralAlternativen.forEach(pluralAlternative -> {
      res.addAll(
          stdPlural(lexeme, pos, lexemStehtMitArtikelAusserImTelegrammstil, pluralAlternative));
    });
  ...
  private static Collection<String> plural(final Lexeme lexeme, final FremdwortTyp fremdwortTyp,
    ...
    if (fremdwortTyp.isFremdwort()) {
      ...
      if (GermanUtil.hatKonsonantischenWortausgang(singular)
        ...
        if (SubstantivPronomenUtil.isMask(lexeme) && !kommtEinemEigennameNahe) { // nicht
          ...
          // Duden 331
          if (StringUtil.endsWith(singular, FREMDE_MASK_WORTAUSGAENGE_PLURAL_BELEBT_MIT_EN)
              && personOderTier) {
    ...
    if (!SubstantivPronomenUtil.isFem(lexeme)) {
      ...
      if (folgeESollteFuerPluralOderSchwacheDeklinationEntfallen(singular)) {
        ...
        final int amEndeNichtFuerUmlautBeruecksichtigen =
            amEndeNichtFuerUmlautBeruecksichtigen(singular);

        final String basisFuerUmlautung =
            singular.substring(0, singular.length() - amEndeNichtFuerUmlautBeruecksichtigen);
        final String stammRest = singular.substring(
            singular.length() - amEndeNichtFuerUmlautBeruecksichtigen, singular.length());
        ...
        if (!basisFuerUmlautung.equals(umgelauteteBasis)) {
          log.warn("Unsichere Pluralbildung (Maskulium endungslos / Umlaut):" + umgelauteteBasis
              + stammRest);
        }
  ...
  /**
   * Ermittelt die SubstantivFlexionsklasse(n) für den Singular eines Nomens (normal, oder
   * Eigenname), wenn es <i>auf ein Artikelwort folgt</i>. Das Lexeme muss im Singular vorkommen
   * (kein Plurale Tantum) (und ein Genus besitzen).
   * <p>
   * Naturgemäß tut sich diese Funktion schwer bei den Flexionsklassen II und IV.
   */
  private static Collection<SubstantivFlexionsklasse> flexionsklassenSingularMitArtikelwort(
      final Lexeme lexeme, final boolean eigenname, final FremdwortTyp fremdwortTyp,
    ...
    if (genus == MASKULINUM) {
      ...
      final Collection<SubstantivFlexionsklasse> ausnahmeAlternativen =
          findAusnahmeMaskFlexionsklasse(nomSg);
  ...
  /**
   * @param kommtEinemEigennameNaheDassGenitivSAuchEntfallenKann ob das Wort einem Eigennamen nahe
   *        kommt, so dass das Genitiv-s im Singular auch entfallen kann
   */
  private Collection<IWordForm> stdSingular(final Lexeme lexeme, final String pos,
    ...
    res.addAll(stdGenSg(lexeme, pos, lexemStehtMitArtikelAusserImTelegrammstil,
        ...
        kommtEinemEigennameNaheDassGenitivSAuchEntfallenKann, personOderTier, plurale));
    ...
    final Collection<IWordForm> datAlternativen = stdDatSg(lexeme, pos,
        ...
        stoffbezeichnungSammelbezeichnungOderAbstraktumArtikelOptional, stammWennOhneEndung,
    ...
    res.addAll(stdNomSg(lexeme, pos, lexemStehtMitArtikelAusserImTelegrammstil,
        etablierteGruppeArtikelSgNurBeiSubjektNoetig,
        stoffbezeichnungSammelbezeichnungOderAbstraktumArtikelOptional, fremdwortTyp,
        personOderTier, datAlternativen, akkAlternativen, plurale));
  ...
  public String stammWennMitEndung(final String stammWennOhneEndung) {
    ...
    // GeheimnisSen)?
    final String ausnahmeStamm =
        findAusname(stammWennOhneEndung, AUSNAHMEENDEN_STAMMABWEICHUNGEN_KASUSFLEXION);
  ...
  private static ImmutableCollection<IWordForm> stdNomSg(final Lexeme lexeme, final String pos,
    ...
    final boolean substantiviertesAdjektiv = StringFeatureLogicUtil.stringToBoolean(
        lexeme.getStringFeatureValue(SUBSTANTIVIERTES_ADJEKTIV_KEY));
  ...
  /**
   * @param etablierteGruppeArtikelSgNurBeiSubjektNoetig Z.B. "Pianist"
   */
  private static Wortform stdNomSg(final Lexeme lexeme, final String pos,
    ...
    final boolean nomMoeglicherweiseDatOderAkkMitUnterlassenerKasusflexion =
        !substantiviertesAdjektiv && (datUnterschiedlichVonNom || akkUnterschiedlichVonNom);
    ...
    final Wortform nomSgWortform = SubstantivFlektierer.buildSubstantivWortform(lexeme, pos,
        KasusInfo.nomNomen(nomMoeglicherweiseDatOderAkkMitUnterlassenerKasusflexion), SINGULAR,
        artikelwortbezug, nomSg);
  ...
  private static boolean eigennameOderWieEigennameGebraucht(final String pos, final Lexeme lexeme) {
    ...
    if (!pos.equals(GermanPOS.NN.toString())) {
      throw new IllegalStateException(
          "SubstantivFlektierer: pos was " + pos + ". NE oder NN expected.");
    }
  ...
  private static boolean wieEinEigennameGebraucht(final Lexeme lexeme) {
    return StringFeatureLogicUtil.stringToBoolean(
        lexeme.getStringFeatureValue(NN_WIE_EIN_EIGENNAME_GEBRAUCHT_KEY));
  }

  private static Artikelwortbezug calcArtikelwortbezugSg(
      final boolean lexemStehtMitArtikelAusserImTelegrammstil,
    ...
    // Ich habe z.B. das Gefühl, dass das Wort "Situation" eigentlich nie allein stehen kann.
  ...
  private static Collection<IWordForm> stdGenSg(final Lexeme lexeme, final String pos,
    ...
    if (flexKlassen.contains(SubstantivFlexionsklasse.STARK_II)
      ...
      final GenitivSgStarkOderGemischtResult genitivStarkOderGemischtResult =
          stdGenSgStarkOderGemischt(lexeme, pos, lexemStehtMitArtikelAusserImTelegrammstil,
              etablierteGruppeArtikelSgNurBeiSubjektNoetig,
              stoffbezeichnungSammelbezeichnungOderAbstraktumArtikelOptional, fremdwortTyp,
              stammWennOhneEndung, stammWennMitEndung,
              kommtEinemEigennameNaheDassGenitivSEntfallenKann, eigenname, flexKlassen);
      res.addAll(genitivStarkOderGemischtResult.getGenitives());
      formAufSOhneArtikelwortBereitsHinzugefuegt =
          genitivStarkOderGemischtResult.isEnthaeltFormAufSOhneArtikelwort();
    } else {
    ...
    if (CollectionUtil.containsAny(flexKlassen, SubstantivFlexionsklasse.SCHWACH_IV,
      ...
      final boolean gemischtTypBuchstabe =
          CollectionUtil.containsAny(flexKlassen, SubstantivFlexionsklasse.GEMISCHT_TYP_BUCHSTABE);
    ...
    final boolean nnDasWieEinEigennameGebrauchtWird =
        eigenname ? false : wieEinEigennameGebraucht(lexeme);
  ...
  private static GenitivSgStarkOderGemischtResult stdGenSgStarkOderGemischt(final Lexeme lexeme,
    ...
    final boolean eigennameOderAehnlichesDassGenitivSEntfallenKann =
        kommtEinemEigennameNaheDassGenitivSEntfallenKann || // des
                                                            // Peter(s),
                                                            // des
                                                            // Montag(s)
    ...
    final GenitivSgStarkOderGemischtResult genitivStarkOderGemischtResult =
        stdGenSgStark(lexeme, pos, fremdwortTyp, // Haus, Peter, Frieden, Felsen,
    ...
    if (CollectionUtil.containsAny(flexKlassen, SubstantivFlexionsklasse.GEMISCHT_TYP_FELS,
      ...
      final GenitivSgStarkOderGemischtResult genitivStarkResultFuerStammOhneEn =
          stdGenSgStark(lexeme, pos, fremdwortTyp, // Fels, Herz
  ...
  /**
   * Lässt das Wort wie es ist - außer <code>gemischt</code> wäre <code>true</code>. Falls
   * <code>gemischt</code> <code>true</code> ist, dann stellt diese Methode sicher, dass der
   * Rückgabewert mit einem "n" (oder mit "en") endet.
   * <p>
   * Haus ergibt also Haus, Friede und Frieden hingegeben führen beide zu Frieden, Fels und Felsen
   * führen beide zu Felsen.
   * <p>
  ...
  /**
   * Diese Methode stellt sicher, dass der Rückgabewert mit einem "n" (oder mit "en") endet.
   * <p>
   * Friede und Frieden führen also beide zu Frieden, Fels und Felsen führen beide zu Felsen.
   * <p>
   * (Dies ist notwendig für die gemischten Deklinationen.)
   */
  ...
  private static GenitivSgStarkOderGemischtResult stdGenSgStark(final Lexeme lexeme,
      final String pos, final FremdwortTyp fremdwortTyp,
      final boolean lexemStehtMitArtikelAusserImTelegrammstil,
      final boolean etablierteGruppeArtikelSgNurBeiSubjektNoetig,
      final boolean stoffbezeichnungSammelbezeichnungOderAbstraktumArtikelOptional,
      final String stammWennOhneEndung, final String stammWennMitEndung,
      final boolean eigennameOderAehnlichesDassGenitivSEntfallenKann, final boolean eigenname) {
    final ImmutableList.Builder<IWordForm> res = ImmutableList.builder();
    ...
    if (eigenname || eigennameOderAehnlichesDassGenitivSEntfallenKann) {
      ...
      if (!endungsloseFormBereitsHinzugefügt) {
        final KasusInfo genitivTypEndungslos = GermanUtil.endetAufSLaut(stammWennOhneEndung)
            ? KasusInfo.GEN_S : KasusInfo.GEN_OHNE_S_UND_R;

        res.add(SubstantivFlektierer.buildSubstantivWortform(lexeme, pos, genitivTypEndungslos,
            SINGULAR, Artikelwortbezug.ZWINGEND_MIT_ARTIKELWORT_AUCH_IM_TELEGRAMMSTIL,
            stammWennOhneEndung));
      }
    }
  ...
  private static Collection<Wortform> stdGenSgEigennamendeklination(final Lexeme lexeme,
      final String pos, final boolean lexemStehtMitArtikelAusserImTelegrammstil,
      final boolean etablierteGruppeArtikelSgNurBeiSubjektNoetig,
      final boolean stoffbezeichnungSammelbezeichnungOderAbstraktumArtikelOptional,
      final String stammWennOhneEndung, final String stammWennMitEndung,
    ...
    final Artikelwortbezug artikelwortBezug =
        genus == FEMININUM ? Artikelwortbezug.ZWINGEND_OHNE_ARTIKELWORT_UND_KEIN_NOMINATIV :
    ...
    if (GermanUtil.endetAufSLaut(stammWennOhneEndung)) {
      ...
      if (!formAufSOhneArtikelwortBereitsHinzugefuegt) {
        // Annas, Mutters
        res.add(SubstantivFlektierer.buildSubstantivWortform(lexeme, pos, KasusInfo.GEN_S, SINGULAR,
            artikelwortBezug, stammWennMitEndung + "s"));
  ...
  private static Wortform stdGenSgEndungslos(final Lexeme lexeme, final String pos,
    ...
    final Artikelwortbezug artikelwortbezugFuerGattungsdeklinationGenitiv =
        eigenname ? Artikelwortbezug.ZWINGEND_MIT_ARTIKELWORT_AUCH_IM_TELEGRAMMSTIL : // der
        // Anna
        // Haus,
        // *Anna
        // Haus
    ...
    return SubstantivFlektierer.buildSubstantivWortform(lexeme, pos, KasusInfo.GEN_OHNE_S_UND_R,
        SINGULAR, artikelwortbezugFuerGattungsdeklinationGenitiv, stammWennOhneEndung);
  }
  ...
  private static Wortform stdGenSgSchwach(final Lexeme lexeme, final String pos,
      ...
      final String stammWennMitEndung) {
    final Artikelwortbezug artikelwortbezug = calcArtikelwortbezugSg(
        lexemStehtMitArtikelAusserImTelegrammstil, lexemStehtMitArtikelAusserImTelegrammstil, // TODO?
                                                                                              // Ich
                                                                                              // glaube,
                                                                                              // alle
                                                                                              // schwache
    ...
    if (folgeESollteFuerPluralOderSchwacheDeklinationEntfallen(stammWennMitEndung)
      ...
      return SubstantivFlektierer.buildSubstantivWortform(lexeme, pos, KasusInfo.GEN_OHNE_S_UND_R,
          SINGULAR, artikelwortbezug, stammWennMitEndung + "n");
    }

    // des Prinz-en
    return SubstantivFlektierer.buildSubstantivWortform(lexeme, pos, KasusInfo.GEN_OHNE_S_UND_R,
        SINGULAR, artikelwortbezug, stammWennMitEndung + "en");
  }
  ...
  private static ImmutableCollection<IWordForm> stdDatEndungslosStarkOderGemischt(
    ...
    if (flexKlassen.contains(SubstantivFlexionsklasse.STARK_II)) {
      if (!StringUtil.endsWith(stammWennMitEndung, "el")) { // *dem
        ...
        if (genitivendungEsErlaubtBeiStarkerDeklination(stammWennOhneEndung, fremdwortTyp)) {
          ...
          final Artikelwortbezug artikelwortBezugFuerDativE =
              eigenname ? Artikelwortbezug.ZWINGEND_MIT_ARTIKELWORT_AUCH_IM_TELEGRAMMSTIL
    ...
    CollectionUtil.addIfNotNull(res, alterDatOderAkkAufEnOderN(lexeme, pos, eigenname, gemischt,
   ...
   */
  private static IWordForm alterDatOderAkkAufEnOderN(final Lexeme lexeme, final String pos,
      final boolean eigenname, final boolean gemischtFlektiert, final String stammWennMitEndung,
  ...
  private static ImmutableCollection<IWordForm> stdDatSgSchwachAuchEigennamen(final Lexeme lexeme,
      final String pos, final boolean lexemStehtMitArtikelAusserImTelegrammstil,
      final boolean etablierteGruppeArtikelSgNurBeiSubjektNoetig,
      final boolean stoffbezeichnungSammelbezeichnungOderAbstraktumArtikelOptional,
      final String stammWennOhneEndung, final String stammWennMitEndung, final boolean eigenname) {
    final ImmutableList.Builder<IWordForm> res = ImmutableList.builder();
    ...
    final Artikelwortbezug artikelwortbezugFuerGattungsdeklinationDativSchwach =
        eigenname ? Artikelwortbezug.ZWINGEND_MIT_ARTIKELWORT_AUCH_IM_TELEGRAMMSTIL
            : artikelwortbezugLexemDativ;
  ...
  private static Collection<IWordForm> stdAkkSg(final Lexeme lexeme, final String pos,
    ...
    if (flexKlassen.contains(SubstantivFlexionsklasse.ENDUNGSLOS_I)
      ...
      res.addAll(stdAkkEndungslosStarkOderGemischt(lexeme, pos,
          lexemStehtMitArtikelAusserImTelegrammstil, etablierteGruppeArtikelSgNurBeiSubjektNoetig,
          stoffbezeichnungSammelbezeichnungOderAbstraktumArtikelOptional, eigenname,
  ...
  private static ImmutableCollection<IWordForm> stdAkkEndungslosStarkOderGemischt(
      final Lexeme lexeme, final String pos,
      final boolean lexemStehtMitArtikelAusserImTelegrammstil,
      final boolean etablierteGruppeArtikelSgNurBeiSubjektNoetig,
      final boolean stoffbezeichnungSammelbezeichnungOderAbstraktumArtikelOptional,
      final boolean eigenname, final String stammWennOhneEndung, final String stammWennMitEndung,
      final Collection<SubstantivFlexionsklasse> flexKlassen) {
    final ImmutableList.Builder<IWordForm> res = ImmutableList.builder();
    ...
    res.add(SubstantivFlektierer.buildSubstantivWortform(lexeme, pos, KasusInfo.AKK, SINGULAR,
        artikelwortbezug, stammMitNOderEnFallsGemischt(stammWennOhneEndung, gemischt))); // Haus,
    ...
    if (CollectionUtil.containsAny(flexKlassen, SubstantivFlexionsklasse.GEMISCHT_TYP_FELS,
      ...
      // dem Fels, dem Herz, dem Kunstherz
      res.add(SubstantivFlektierer.buildSubstantivWortform(lexeme, pos, KasusInfo.AKK, SINGULAR,
          artikelwortbezug, stammOhneEn(stammWennOhneEndung))); // Fels, Herz, Kunstherz
    }
  ...
  private static Collection<IWordForm> stdAkkSgSchwachAuchEigennamen(final Lexeme lexeme,
      final String pos, final boolean lexemStehtMitArtikelAusserImTelegrammstil,
      final boolean etablierteGruppeArtikelSgNurBeiSubjektNoetig,
      final boolean stoffbezeichnungSammelbezeichnungOderAbstraktumArtikelOptional,
      final String stammWennOhneEndung, final String stammWennMitEndung, final boolean eigenname) {
    ...
    final Artikelwortbezug artikelwortbezugFuerGattungsdeklinationAkkSchwach =
        eigenname ? Artikelwortbezug.ZWINGEND_MIT_ARTIKELWORT_AUCH_IM_TELEGRAMMSTIL
  ...
  private static Collection<IWordForm> stdPlural(final Lexeme lexeme, final String pos,
    ...
    if (Boolean.TRUE.equals(endetUnbetontAufEElEr) || endetUnbetontAufEElEr == null) {
      // den Trümmern
      res.add(SubstantivFlektierer.buildSubstantivWortform(lexeme, pos, KasusInfo.DAT, PLURAL,
          artikelwortbezug, plural + "n"));
    }
    ...
    if (Boolean.FALSE.equals(endetUnbetontAufEElEr) || // den Sachen
      ...
      res.add(SubstantivFlektierer.buildSubstantivWortform(lexeme, pos, KasusInfo.DAT, PLURAL,
          artikelwortbezug, plural));
    }

    // AKKUSATIV
    res.add(SubstantivFlektierer.buildSubstantivWortform(lexeme, pos, KasusInfo.AKK, PLURAL,
        artikelwortbezug, plural));
  ...
  /**
   * Bei Wörtern wie "Garten" darf man nicht versuchen, das 'e' umzulauten, sondern das 'a'!
   *
   * @return Wieviele Zeichen am Ende nicht für die Umlautung berücksichtigt werden dürfen z.B. 2
   *         bei <code>Gart<b>en</b></code>
   */
  ...
  public static Wortform buildSubstantivWortform(final ILexeme lexeme, final String pos,
      final KasusInfo kasusInfo, final Numerus numerus, final Artikelwortbezug artikelwortbezug,
      final String string) {
    ...
    final Wortform res =
        new Wortform(lexeme, pos, string, features, NothingInParticularSemantics.INSTANCE);
  ...
  private static Collection<String> findPluralAusnahme(final String singular) {
    final Collection<String> pluralausnahmenMitMehrerenAlternativen =
        findAusnahmealternativen(singular, AUSNAHMEENDEN_MIT_ALTERNATIVEN_PLURAL);
  ...
  private static String tauscheEndeAus(final String basis, final String altesEnde,
      final String neuesEnde) {
  ...
  private static boolean folgeESollteFuerPluralOderSchwacheDeklinationEntfallen(
      final String singular) {
    /*
     * Duden 279 (Regel G3): Wenn ein Substantiv im Singular auf unbetontes -e, -el, -em, -en oder
     * -er ausgeht, wird das e der folgenden Endung getilgt.
     */
