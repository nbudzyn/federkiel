...
/**
 * Ein bestimmter Typ von Verbergänzung: "Seiner Mutter [wird er] das Geld geben"[.]
 * <p>
 * Ein reiner Infinitiv (also ohne "zu") mit seinen Ergänzungen und Angaben - allerdings nicht als
 * (kontinuierliche) Phrase, sondern als Rollenrahmen.
 */
public class ReinerInfinitivTyp extends AbstractErgaenzungsOderAngabenTyp {
  ...
  public RoleFrameSlot buildSlot(final String person, final Genus genusDesSubjekts,
    ...
    return RoleFrameSlot.of("verb",
        SlotRequirements.of("N_PRONOMEN_PHR_REIHUNG", buildFeatureCondition(person,
            genusDesSubjekts, numerusDesSubjekts, hoeflichkeitsformDesSubjekts))); // "Seiner Mutter
                                                                                   // [...] das Geld
                                                                                   // geben"
    // "[Er wird] sich die Haare fönen", aber nicht *"[Ich werde] sich die Haare fönen"
  ...
  private IFormula<FeatureAssignment> buildFeatureCondition(final String person, final Genus genusDesSubjekts,
      final Numerus numerusDesSubjekts, final String hoeflichkeitsformDesSubjekts) {
    return
        // Eine Bedingung, die sicherstellt, dass es (in der - möglicherweise
